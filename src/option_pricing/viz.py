...
def pnl_from_pricing_method(pricer, S0, K, r, q, sigma, T, method_kwargs=None, s_min_mult=0.5, s_max_mult=1.5, n=100):
    ...
    for s in S_range:
        ...
        prices.append(price)
    # PnL for long one option = price - price_at_S0
